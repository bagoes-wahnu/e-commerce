...
@section('title')
    <title>Keranjang Belanja - Kpopstore.sby</title>
@endsection
							...
							<tr class="out_button_area">
								...
								<td>
									<div class="checkout_btn_inner">
										<a class="btn gray_btn btn-sm" href="{{ route('front.product') }}">Continue Shopping</a>
										{{-- @if(!$carts == 0) --}}
										<a class="btn main_btn btn-sm" href="{{ route('front.checkout') }}">Proceed to checkout</a>
										{{-- @endif --}}
									</div>
								</td>
							</tr>
