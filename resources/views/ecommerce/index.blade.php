...
@section('title')
    <title>Kpopstore.sby - Toko KStuff Surabaya</title>
@endsection
				...
				<div class="banner_content row">
					<div class="offset-lg-2 col-lg-8">
						...
						{{-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
							...
							<p>Barang - barang mengenai KPOP seperti Album, Mini Album, Merchandise, dan Kstuff lainya tersedia disini.</p>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="main_title">
						...
						<p>Cek selalu barang - barang terbaru milik kami.</p>
					</div>
				</div>
				<div class="row">
